...
function get_max(){
	$(".bar_group").each(function(){
		...
		void 0!==$(this).attr("max")?$(this).data("bg_max",$(this).attr("max"))
...
function show_values(){
	$(".bar_group__bar").each(function(){
		...
		($(this).css("margin-bottom","40px"),
			...
			($(this).append('<p class="bar_label_min">0 '
				+$(this).attr("unit")+"</p>"),
			$(this).append('<p class="bar_label_max">'+$(this).parent().data("bg_max")+" "
				+$(this).attr("unit")+"</p>"))
...
function show_tooltips(){
	$(".bar_group__bar").each(function(){
		...
		($(this).css("margin-bottom","40px"),
			$(this).append('<div class="b_tooltip"><span>'+$(this).attr("value")
